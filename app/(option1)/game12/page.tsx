...
export default function Home() {
    ...
    <div className="container" style={{margin:'auto', aspectRatio: '16 / 9', width: '100%', maxWidth: '800px', background: 'lightgray',display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
