...
dude34()
  ...
  return (
    <div className="grid gap-6">
      {/* Display digits prop if provided */}
      {typeof digits !== 'undefined' && (
        <div className="text-lg font-bold text-center text-blue-700">Digits: {digits}</div>
      )}
      {typeof room !== 'undefined' && (
        <div className="text-lg font-bold text-center text-blue-700">room: {room}</div>
      )}
      {error && (
